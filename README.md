...
[![NPM](https://badge.fury.io/js/@node-3d%2Fdeps-qt-core.svg)](https://badge.fury.io/js/@node-3d%2Fdeps-qt-core)
[![Lint](https://github.com/node-3d/deps-qt-core/actions/workflows/lint.yml/badge.svg)](https://github.com/node-3d/deps-qt-core/actions/workflows/lint.yml)
[![Test](https://github.com/node-3d/deps-qt-core/actions/workflows/test.yml/badge.svg)](https://github.com/node-3d/deps-qt-core/actions/workflows/test.yml)

```bash
npm install @node-3d/deps-qt-core
```
...
Before any import of Qt-dependent module, there should be `require('@node-3d/deps-qt-core')`.
...
```bash
gh release download <tag> -R node-3d/deps-qt-core -p <platform>.gz
gh attestation verify <platform>.gz -R node-3d/deps-qt-core
```
